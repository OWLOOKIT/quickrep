...
class NorthwindProductReport extends ParentTabularReport
{
    ...
    */
    ...
    {
        return ('Quickrep Demo: Northwind Product Report');
    }
...
<ul>
	<li>Currently, not very much, but soon, we will use this report to test the auto-column summary features of Quickrep </li>
</ul>
