...
class NorthwindOrderSlowReport extends ParentTabularReport
{
    ...
    */
    ...
    {
        return ('Quickrep Demo: Northwind Order Slow Report');
    }
    ...
    */
    ...
    {
        $html = "<p>This report is just like <a href='/Quickrep/NorthwindOrderIndexReport'>Northwind Order Index Report</a> except that it does not use indexes. So for sufficiently large data.. it should be slower.
<br>
