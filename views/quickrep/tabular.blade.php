<div id="app">
    <div class="container-fluid">
        ...
        <table class="display table table-bordered table-condensed table-striped table-hover" id="report_datatable"
    ...
    <div class="modal fade" id="report_download_modal" tabindex="-1" role="dialog"
         aria-labelledby="report_download_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered"
                                       id="download-search-filter-options-table">
                                </table>
                            </div>
                        </div>
                        <br>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered"
                                       id="download-url-params-options-table">
                                </table>
                            </div>
                        </div>
                        <br>
...
<script type="text/javascript" src="/vendor/Owlookit/quickrep/quickrepbladetabular/datatables/datatables.js"></script>
<script type="text/javascript" src="/vendor/Owlookit/quickrep/core/bootstrap/bootstrap.bundle.min.js"></script>
<script type="text/javascript" src="/vendor/Owlookit/quickrep/core/js/moment.min.js"></script>
<script type="text/javascript" src="/vendor/Owlookit/quickrep/core/js/daterangepicker.js"></script>
<script type="text/javascript" src="/vendor/Owlookit/quickrep/core/js/jquery.doubleScroll.js"></script>
<script type="text/javascript"
        src="/vendor/Owlookit/quickrep/quickrepbladetabular/js/jquery.dataTables.yadcf.js"></script>
<script type="text/javascript" src="/vendor/Owlookit/quickrep/core/js/quickrep.js"></script>

<script type="text/javascript">

    $(document).ready(function () {

        var quickrep = new Quickrep(
        ...
        function setup_download_modal_for_display() {
            ...
            if (quickrep.getSearchFilters().length > 0) {
                $.each(quickrep.getSearchFilters(), function (key, option) {
                    for (var i in option) {
            ...
            if (Object.keys(quickrep.getUrlSearchParams()).length > 0) {
                $.each(quickrep.getUrlSearchParams(), function (key, option) {
                    for (var i in option) {
        ...
        $("#initiate-report-download").click(function (e) {
            ...
            quickrep.serverDownloadRequest().done(function () {
        ...
        set_cache_timer();
        var api_params = quickrep.getAllApiParams();
        ...
        $.getJSON(
            ...
            var buttons = [
                ...
                See: https://github.com/Owlookit/Quickrep/issues/56
                */
                /*
                {
                    extend: 'collection',
                ...
                },
                {
                    ...
                    buttons: [{
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            quickrep.setDownloadFileType('csv');
                            var downloadURI = quickrep.getDownloadURI();
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            // Add the fully built download URI to the modal (this can be used to link to the download)
                            quickrep.setDownloadFileType('excel')
                            var downloadURI = quickrep.getDownloadURI();
                            $("#current-download-link").val(downloadURI);
            ...
            var defaultSortOrderParam = quickrep.getPassthroughParam('order');
            ...
            var defaultPageLength = localStorage.getItem("Quickrep_defaultPageLength");
            ...
            dataTableOptions = {
                ...
                */
                ajax: function (data, callback, settings) {
                    ...
                    quickrep.clearSearchFilters();

                    // Tell our quickrep state about each column filter
                    columns.forEach(function (item) {
                        if (item.search.value != "") {
                            quickrep.pushColumnSearchFilter(item.data, item.search.value);
                        }
                    });

                    // Tell our quickrep state about the global filter
                    if (data.search.value != "") {
                        quickrep.pushGlobalSearchFilter(data.search.value);
                    }
                    ...
                    */
                    ...
                    var passthrough_params = quickrep.getPassthroughParams();
                    ...
                    var merge_get_params = {
                        ...
                        "filter": quickrep.getSearchFilters(),
                    ...
                    localStorage.setItem("Quickrep_defaultPageLength", length);
                    ...
                    // This is the AJAX call to the quickrep API to get the data for datatables
                    $.getJSON('{{ $report_uri }}', param
                        ...
                        var search_filters = quickrep.getSearchFilters();
