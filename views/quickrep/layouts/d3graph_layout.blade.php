...
<head>
	...
	<link type="text/css" rel="stylesheet" href="/vendor/Owlookit/quickrep/quickrepbladegraph/css/floating.feedback.css"/>
	...
	<script type='text/javascript' language='javascript' src='/vendor/Owlookit/quickrep/quickrepbladegraph/js/d3.3.5.17.min.js'></script>
	...
	<!-- font awesome js -->
	<script type="text/javascript" language="javascript" src="/vendor/Owlookit/quickrep/core/font-awesome/js/all.min.js"></script>
