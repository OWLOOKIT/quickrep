...
<link rel="stylesheet" type="text/css" href='{{ asset("vendor/Owlookit/quickrepbladecard/datatables/datatables.min.css") }}'/>
...
@include('Quickrep::menu')

@include('Quickrep::card')
