    ...
    @if ($report->is_fluid())
        <div class='container-fluid'>
            @else
                ...
                <script type="text/javascript" src="/vendor/Owlookit/core/js/jquery.min.js"></script>
                <script type="text/javascript" src="/vendor/Owlookit/core/botstrap/bootstrap.bundle.min.js"></script>
