...
"></div>
                ...
                <script type="text/javascript"
                        src="/vendor/Owlookit/quickrep/core/bootstrap/bootstrap.bundle.min.js"></script>
                        ...
                        $.getJSON('{{ $summary_uri }}',
                            ...
                            .done(function (header_data) { //this means I have clean results in the data variable...
                                ...
                                */
                                ...
                                localStorage.setItem("Quickrep_defaultPlageLength", header_data.length);
                                                ...
                                                if (i != 0) { // then this is not the first card.
                                                    if (last_block_id == this_card.card_layout_block_id) {
                                                        ...
                                                        if (isset(this_card.card_layout_block_label)) { //we have a label... so we will use it to seperate the card blocks
                                                            ...
                                                            real_card_group_label = `
</div> <!-- end the row -->	<div class="quickrep-card-group-label">
...
// Refresh sockets on page reload, in case we had options set, and did a "refresh"
                ...
                <!-- Data View Modal -->
                <div class="modal fade" id="current_data_view" tabindex="-1" role="dialog"
                     aria-labelledby="current_data_view" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <form id="sockets-form" method="post">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="save-sockets" class="btn btn-primary">Save changes
                                    </button>
                                </div>
                            </form>
                        </div>
