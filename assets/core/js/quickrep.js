/*
 This is the core QuickRep JS library for communication with server
 It handles:
 ...
 */
var Quickrep = function( reportURI, downlaodURI, options ) {
     ...
     * @param params
     *
     * Perform a download to the Quickrep API using the current report
