 ...
 * Each report sub-class has it's own file in Quickrep/Reports
 * such as Quickrep/Reports/Tabular/AbstractTabularReport.php
...
abstract class QuickrepReport implements QuickrepReportInterface
{
    /**
     * $INDICIES
     ...
     */
    protected $HOW_LONG_TO_CACHE_IN_SECONDS = 600; //cache is always off by default.
    /**
     * @var bool
     *
     ...
     * Example: /Quickrep/ExampleReport/MyGroupCode
     *
     * @var string
     */
    private $_code = null;
     ...
     * Example: /Quickrep/ExampleReport/MyGroupCode/MyOption1/MyOption2/MyOption3
     *
     * @var array
     */
...
private $_activeSockets = [];
    ...
    public static function testMeWithThis()
    {
        $return_structure = [
            ...
            'Input' => [
                'GET_variable_one' => 'GET_value_one',
                'GET_variable_two' => 'GET_value_two',
                'POST_variable_one' => 'POST_value_one',
                'POST_and_so_on' => 'POST_and_so_forth'
            ],
        ];
    ...
    public function getAllSockets(string $wrenchName = null)
    {
        ...
        if ($wrenchName) {
            ...
            if ($sockets === null) {
                throw new Exception(
                    "Quickrep SocketWrench Error: getAllSockets: No sockets for wrench name $wrenchName"
                );
            }
        } else {
            throw new Exception("Quickrep SocketWrench Error: getAllSockets:  No wrench name provided");
        }
    ...
    public function getSocket(string $wrenchName = null)
    {
        ...
        if ($wrenchName) {
            ...
            if ($socket === null) {
                throw new Exception("Quickrep SocketWrench Error: No socket for wrench name $wrenchName");
            }
            ...
            throw new Exception("Quickrep SocketWrench Error: getSocket function called, but No wrench name provided");
        }
     ...
     * configuration variable in quickrep config for the global 'enable' of SQL printing
     */
    ...
    public function GetReportName(): string
    {
        ...
        $error = "The requested Quickrep Report class exists, but does not have the GetReportName() function defined, this is a required function";
        throw new Exception($error);
    }
    ...
    {
        $footer = "<!-- placeholder for Quickrep Report Footer HTML -->";
...
JS;
    ...
    public function GetSQL()
    {
        ...
        $error = "The requested Quickrep Report class ($this_class)  exists, but does not have the GetSQL() function defined, this is a required function";
        throw new Exception($error);
    }
