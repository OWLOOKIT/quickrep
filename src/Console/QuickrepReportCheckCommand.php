...
class QuickrepReportCheckCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'quickrep:report_check {--include_durc}';
     ...
     * @var string
     */
    protected $description = 'Loop Through Each Quickrep Report with their default arguments and see if they correctly run. Log to the Quickrep Config Database';
