...
class MakeGraphReportCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'quickrep:make_graph {report_name} {{--squash}}';
    ...
    public function handle()
    {
        ...
        $namespace = config('quickrep.REPORT_NAMESPACE', 'Quickrep');
