...
use Owlookit\Quickrep\Models\Socket;
   ...
   */
    public function fetchAllSocketsForWrenchKey( $key )
    {
		...
		return($socket_list_to_return);
            ...
            throw new \Exception("Quickrep SocketWrench Error: No Wrench found for lookup string=`$key`");
        }
     ...
     * TODO, make a whole logging and warning system : https://github.com/Owlookit/Quickrep/issues/107
     *
     */
