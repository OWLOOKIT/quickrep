...
class TreeReportGenerator extends AbstractGenerator
{
    ...
    protected $cache_db = '_quickrep_cache'; //TODO this should be set in config
    ...
    public function __construct(CachedTreeReport $cache)
    {
        ...
        $this->cache_db = '_quickrep_cache'; //more hard-coding.
...
";
        ...
        $results = QuickrepDatabase::connection($this->cache->getConnectionName())->select(DB::raw($select_sql));
