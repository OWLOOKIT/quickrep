...
{
    protected $cache_db = '_quickrep_cache';
     ...
     *
     * @param QuickrepReport $report The report to be cached
     *
    ...
    public function typesLookup()
    {
        ...
        $fields = QuickrepDatabase::getTableColumnDefinition($this->getTableName(), $this->connectionName);
        $node_index = 0;
        $link_index = 0;
        ...
        foreach ($fields as $field) {
            ...
            if (QuickrepDatabase::isColumnInKeyArray($column, $this->getReport()->getLinkTypeColumns())) {
